  ...
  [2],
  {
    ...
    "8oxB": function (e, t) {
      ...
      function p() {
        u &&
          c &&
          ((u = !1), c.length ? (l = c.concat(l)) : (h = -1), l.length && f());
      }
      function f() {
        if (!u) {
          var e = a(p);
            ...
            typeof (r = function () {
              ...
              !(function (e) {
                ...
                Zone.__load_patch("ZoneAwarePromise", (e, t, n) => {
                  ...
                  const w = s("rejectionHandledHandler");
                  function E(e) {
                    if (0 === e[g]) {
                      try {
                        const n = t[w];
                        n &&
                          "function" == typeof n &&
                          n.call(this, { rejection: e[m], promise: e });
                      } catch (n) {}
                      e[g] = !1;
              ...
              const _ =
                ...
                w = function (e) {
                  ...
                  let t = b[e.type];
                  t || (t = b[e.type] = h("ON_PROPERTY" + e.type));
              ...
              function E(n, o, r) {
                ...
                const a = s.get,
                  ...
                  l = o.substr(2);
                let u = b[l];
                u || (u = b[l] = h("ON_PROPERTY" + l)),
                  (s.set = function (e) {
                    let t = this;
                    t || n !== d || (t = d),
                      t &&
                        (t[u] && t.removeEventListener(l, w),
                        c && c.apply(t, g),
                        "function" == typeof e
                          ? ((t[u] = e), t.addEventListener(l, w, !1))
                          : (t[u] = null));
                  }),
                  (s.get = function () {
                    let e = this;
              ...
              function D(e) {
                ...
                for (r in n)
                  "prototype" !== r && n.hasOwnProperty(r) && (d[e][r] = n[r]);
              }
              function P(t, o, r) {
                let s = t;
              ...
              function B(e, t, o) {
                ...
                function g(t, o) {
                  ...
                  o && o.prepend && (S = _[h(o.prepend)] = _[o.prepend]);
                  const P = p
                      ? function (e) {
                          if (!T.isExisting)
                            return b.call(
                    ...
                    L = function (t, n, r, s, i = !1, a = !1) {
                      return function () {
                        const c = this || e;
                        let l = arguments[0];
                        o &&
                          o.transferEventName &&
                          (l = o.transferEventName(l));
                        let u = arguments[1];
                ...
                let m = [];
                for (let n = 0; n < t.length; n++) m[n] = g(t[n], o);
                return m;
              }
              function G(e, t) {
                if (!t) {
              ...
              function re(e, t) {
                ...
                if (v) {
                  ...
                  oe(e, te.concat(["messageerror"]), r ? r.concat(t) : r, n(e)),
                    oe(Document.prototype, te, r),
                    void 0 !== e.SVGElement &&
                      oe(e.SVGElement.prototype, te, r),
                    oe(Element.prototype, te, r),
                    oe(HTMLElement.prototype, te, r),
                    oe(HTMLMediaElement.prototype, V, r),
                    oe(HTMLFrameSetElement.prototype, U.concat(X), r),
                    oe(HTMLBodyElement.prototype, U.concat(X), r),
                    oe(HTMLFrameElement.prototype, $, r),
                    oe(HTMLIFrameElement.prototype, $, r);
                ...
                i && oe(i && i.prototype, Y, r),
                  "undefined" != typeof IDBIndex &&
                    (oe(IDBIndex.prototype, K, r),
                    oe(IDBRequest.prototype, K, r),
                    oe(IDBOpenDBRequest.prototype, K, r),
                    oe(IDBDatabase.prototype, K, r),
                    oe(IDBTransaction.prototype, K, r),
                    oe(IDBCursor.prototype, K, r)),
                  o && oe(WebSocket.prototype, Q, r);
              }
                          ...
                          function (e, n) {
                            ...
                            if (e[o]) return b.apply(e, n);
                            {
                              const t = {
                                ...
                                o = u("XMLHttpRequest.send", k, t, m, _);
                              e &&
                                !0 === e[l] &&
                                !t.aborted &&
                                "scheduled" === o.state &&
                    ...
                    (function (t, n) {
                      ...
                      for (let r = 0; r < n.length; r++) {
                        ...
                        if (i) {
                          ...
                          t[s] = ((e) => {
                            const t = function () {
                              return e.apply(this, m(arguments, o + "." + s));
                            };
                            return O(t, e), t;
                          })(i);
                        }
